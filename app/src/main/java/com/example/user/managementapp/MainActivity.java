package com.example.user.managementapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnviewedit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this, ViewAndEdit.class);
                intent.putExtra("cdate",curDate);
                startActivity(intent);
            }
        });
        btnsearch.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this, SearchAppointment.class);
                startActivity(intent);
            }
        });
        btnmove.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this, MoveAppointment.class);
                intent.putExtra("cdate",curDate);
                startActivity(intent);
            }
        });
